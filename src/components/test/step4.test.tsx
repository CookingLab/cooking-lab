...
import { STEP_OPTIONAL, STEP4_TITLE, STEP4_DESCRIPTION, STEP4_DROPDOWN, STEP4_DROPDOWN_ALLERGIES, STEP4_DROPDOWN_RESTRICTIONS, STEP4_ALLERGIES, RESTART } from '../../i18n/constants';
import { setHealth } from '../../redux/cookingLabSlice';
...
describe('Step4 component', () => {
  ...
  it('should set health to correct value on click', () => {
